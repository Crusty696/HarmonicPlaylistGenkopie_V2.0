...
scenario = 'nan_overlap'

cache = Path('C:\\Users\\david\\Documents\\HarmonicPlaylistGenkopie_V2.0-main\\HarmonicPlaylistGenkopie_V2.0-main\\.pytest-candidate-app-nocrash-agent-v3\\popen-gw7\\test_unzureichende_daten_stopp0\\cache.db')
