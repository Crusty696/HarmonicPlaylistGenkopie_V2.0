...
- **Bewusst NICHT umgesetzt** (UX-/Risiko-Entscheidung, dokumentiert): Strategien-Zusammenlegung 11→8 (entfernt sichtbare Auswahloptionen), Mixpoint-Pfad-B-Entkernung (viele direkte Tests, eigener Umbau-Plan), zentrales genres.py (Aufwand L — nächster sinnvoller Schritt), Track-Felder brightness/danceability/etc. behalten (Zukunfts-Features), Tabellen-Update-Helper (Kosmetik).
