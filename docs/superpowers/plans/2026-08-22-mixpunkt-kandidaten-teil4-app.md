...
16. **Laufzeit nach Optimierung** (gemessen 2026-08-22, 500 Paare): `build_pair_candidates` 8,7 ms → 3,3 ms Median (Score/Gates einmal je (Out, In), flache Kopien statt `asdict`); erste App-Messung vor der Optimierung: Generierung Harmonic Flow 231 Tracks 123 s mit Kandidaten vs. 2 s ohne — die Zahl nach der Optimierung steht im Handoff Teil 4.
