...
scenario = 'no_rank_change'

cache = Path('C:\\Users\\david\\Documents\\HarmonicPlaylistGenkopie_V2.0-main\\HarmonicPlaylistGenkopie_V2.0-main\\.pytest-candidate-app-nocrash-agent\\popen-gw0\\test_laufzeitfehler_und_fail_o0\\no_rank_change\\cache.db')
