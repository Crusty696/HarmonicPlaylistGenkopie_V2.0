...
scenario = 'no_recommendations'

cache = Path('C:\\Users\\david\\Documents\\HarmonicPlaylistGenkopie_V2.0-main\\HarmonicPlaylistGenkopie_V2.0-main\\.pytest-candidate-app-nocrash-agent\\popen-gw7\\test_unzureichende_daten_stopp0\\no_recommendations\\cache.db')
