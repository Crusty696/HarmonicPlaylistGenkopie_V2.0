...
scenario = 'wrong_rank_type'

cache = Path('C:\\Users\\david\\Documents\\HarmonicPlaylistGenkopie_V2.0-main\\HarmonicPlaylistGenkopie_V2.0-main\\.pytest-candidate-app-nocrash-agent-v4\\popen-gw0\\test_unzureichende_daten_stopp1\\cache.db')
