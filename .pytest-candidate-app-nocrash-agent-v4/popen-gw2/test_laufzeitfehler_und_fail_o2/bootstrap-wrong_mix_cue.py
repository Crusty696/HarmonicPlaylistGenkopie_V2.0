...
scenario = 'wrong_mix_cue'

cache = Path('C:\\Users\\david\\Documents\\HarmonicPlaylistGenkopie_V2.0-main\\HarmonicPlaylistGenkopie_V2.0-main\\.pytest-candidate-app-nocrash-agent-v4\\popen-gw2\\test_laufzeitfehler_und_fail_o2\\cache.db')
