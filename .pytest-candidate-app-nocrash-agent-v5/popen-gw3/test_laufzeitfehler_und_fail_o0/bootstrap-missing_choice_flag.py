...
scenario = 'missing_choice_flag'

cache = Path('C:\\Users\\david\\Documents\\HarmonicPlaylistGenkopie_V2.0-main\\HarmonicPlaylistGenkopie_V2.0-main\\.pytest-candidate-app-nocrash-agent-v5\\popen-gw3\\test_laufzeitfehler_und_fail_o0\\cache.db')
