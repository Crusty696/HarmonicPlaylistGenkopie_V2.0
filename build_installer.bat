@echo off
REM =========================================================
REM Build Professional Windows Installer for HPG v3.6.0
REM Requires: Inno Setup (https://jrsoftware.org/isdl.php)
REM =========================================================

echo.
echo ========================================================
echo   HPG v3.6.0 - INSTALLER BUILD SCRIPT
echo ========================================================
echo.
...
echo ========================================================
echo.
echo   Installer: installer_output\HPG_v3.6.0_Setup.exe
...
if exist "installer_output\HPG_v3.6.0_Setup.exe" (
    explorer /select,"installer_output\HPG_v3.6.0_Setup.exe"
)
